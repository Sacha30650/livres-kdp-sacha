#!/usr/bin/env python3
"""Download les 32 images du Tome 3 et push sur GitHub. A executer dans a-Shell."""
...
os.system('git clone https://' + TOKEN + '@github.com/Sacha30650/livres-kdp-sacha.git repo')
d = 'repo/Tome-3_Lila-et-la-cle-qui-chante/Sources/images'
os.makedirs(d, exist_ok=True)
for name, fname in IMGS:
    try:
        urllib.request.urlretrieve(BASE + '/' + fname, d + '/' + name + '.png')
        print('+ ' + name + '.png')
...
os.system('git add -A')
os.system('git commit -m "Tome 3 images sources"')
os.system('git push')
print('Done')
